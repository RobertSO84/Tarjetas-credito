...
class Tarjeta_de_credito:
    ...
    def crea_tarjeta(self):
        """
        Crea una tarjeta a partir de un formulario
        """
        try:
            capturado = False
    ...
    def __calcula_nueva_deuda(self):
        """
        Calcula el nivel de dauda para el próximo mes
        """
    ...
    def imprime_reporte(self):
        """
        Imprime el reporte de una tarjeta
        """
    ...
    def pago_recurrente(self, monto):
        """
        Calcula un pago recurrente sobre la tarjeta con un monto preestablecido, hasta que la tarjeta quede en cero
        """
        self.__pagos = monto
        self.__cargos = 0
    ...
    def pagos_distintos(self, *args):
        """
        Calcula un pago recurrente sobre la tarjeta con distintos montos mes a mes
        """
        self.__cargos = 0
        for arg in args:
            self.__pagos = arg
    ...
    def reporte_texto(self):
        """
        Crea un reporte en un archivo de texto
        """
